...
NmfModel <- lm(phobias_4factorv2 ~ age + sex + 
...
NullModel <- lm(phobias_4factorv2 ~ age + sex + abfAZ + attAZ + wmAZ + vmemAZ + fmemAZ + smemAZ + lanAZ +nvrAZ + spaAZ + eidAZ + ediAZ + adiAZ, data = data.NMF)
