...
#Plot predicted mood scores vs actual mood scores.
png(file='/data/jux/BBL/projects/pncT1AcrossDisorder/TablesFigures/Predicted_Actual_vol_Mood.png',width=2000,height=2000,res=300)
par(mar=c(5,5,2,2), cex.axis=2, bty="l")
plot(predict(NmfModel), data.NMF$mood_4factorv2, ylab="Actual Scores", xlab="Predicted Scores", cex.lab=2, pch=19, col="#F59611")
