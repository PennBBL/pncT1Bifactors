############################################
#### NMF AS PREDICTORS OF EXTERNALIZING ####
############################################
...
NmfModel <- lm(externalizing_4factorv2 ~ age + sex + F1_Exec_Comp_Res_Accuracy + F2_Social_Cog_Accuracy + F3_Memory_Accuracy + 
...
NullModel <- lm(externalizing_4factorv2 ~ age + sex + F1_Exec_Comp_Res_Accuracy + F2_Social_Cog_Accuracy + F3_Memory_Accuracy, data = data.NMF)
...
nullCor <- cor.test(predict(NullModel), data.NMF$externalizing_4factorv2)
...
nmfCor <- cor.test(predict(NmfModel), data.NMF$externalizing_4factorv2)
...
#plot(predict(NmfModel), data.NMF$externalizing_4factorv2, ylab="Actual Scores", xlab="Predicted Scores", cex.lab=2, pch=19, col="#F59611")
