...
CTgm_Mood_bifactor<-gam(CT_gmTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorMood*age, data=subjData_short)
CTfrontal_Mood_bifactor<-gam(CT_gmFrontalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorMood*age, data=subjData_short)
CToccipital_Mood_bifactor<-gam(CT_gmOccipitalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorMood*age, data=subjData_short)
CTparietal_Mood_bifactor<-gam(CT_gmParietalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorMood*age, data=subjData_short)
CTtemporal_Mood_bifactor<-gam(CT_gmTemporalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorMood*age, data=subjData_short)

CTgm_Psych_bifactor<-gam(CT_gmTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPsych*age, data=subjData_short)
CTfrontal_Psych_bifactor<-gam(CT_gmFrontalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPsych*age, data=subjData_short)
CToccipital_Psych_bifactor<-gam(CT_gmOccipitalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPsych*age, data=subjData_short)
CTparietal_Psych_bifactor<-gam(CT_gmParietalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPsych*age, data=subjData_short)
CTtemporal_Psych_bifactor<-gam(CT_gmTemporalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPsych*age, data=subjData_short)

CTgm_Ext_bifactor<-gam(CT_gmTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorExt*age, data=subjData_short)
CTfrontal_Ext_bifactor<-gam(CT_gmFrontalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorExt*age, data=subjData_short)
CToccipital_Ext_bifactor<-gam(CT_gmOccipitalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorExt*age, data=subjData_short)
CTparietal_Ext_bifactor<-gam(CT_gmParietalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorExt*age, data=subjData_short)
CTtemporal_Ext_bifactor<-gam(CT_gmTemporalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorExt*age, data=subjData_short)

CTgm_Phb_bifactor<-gam(CT_gmTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPhb*age, data=subjData_short)
CTfrontal_Phb_bifactor<-gam(CT_gmFrontalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPhb*age, data=subjData_short)
CToccipital_Phb_bifactor<-gam(CT_gmOccipitalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPhb*age, data=subjData_short)
CTparietal_Phb_bifactor<-gam(CT_gmParietalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPhb*age, data=subjData_short)
CTtemporal_Phb_bifactor<-gam(CT_gmTemporalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPhb*age, data=subjData_short)

CTgm_OverallPsy_bifactor<-gam(CT_gmTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorOverallPsy*age, data=subjData_short)
CTfrontal_OverallPsy_bifactor<-gam(CT_gmFrontalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorOverallPsy*age, data=subjData_short)
CToccipital_OverallPsy_bifactor<-gam(CT_gmOccipitalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorOverallPsy*age, data=subjData_short)
CTparietal_OverallPsy_bifactor<-gam(CT_gmParietalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorOverallPsy*age, data=subjData_short)
CTtemporal_OverallPsy_bifactor<-gam(CT_gmTemporalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorOverallPsy*age, data=subjData_short)
...
CTgm_Mood_bifactor3<-gam(CT_gmTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorMood*age, data=subjData_subset)
CTfrontal_Mood_bifactor3<-gam(CT_gmFrontalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorMood*age, data=subjData_subset)
CToccipital_Mood_bifactor3<-gam(CT_gmOccipitalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorMood*age, data=subjData_subset)
CTparietal_Mood_bifactor3<-gam(CT_gmParietalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorMood*age, data=subjData_subset)
CTtemporal_Mood_bifactor3<-gam(CT_gmTemporalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorMood*age, data=subjData_subset)

CTgm_Psych_bifactor3<-gam(CT_gmTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPsych*age, data=subjData_subset)
CTfrontal_Psych_bifactor3<-gam(CT_gmFrontalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPsych*age, data=subjData_subset)
CToccipital_Psych_bifactor3<-gam(CT_gmOccipitalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPsych*age, data=subjData_subset)
CTparietal_Psych_bifactor3<-gam(CT_gmParietalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPsych*age, data=subjData_subset)
CTtemporal_Psych_bifactor3<-gam(CT_gmTemporalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPsych*age, data=subjData_subset)

CTgm_Ext_bifactor3<-gam(CT_gmTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorExt*age, data=subjData_subset)
CTfrontal_Ext_bifactor3<-gam(CT_gmFrontalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorExt*age, data=subjData_subset)
CToccipital_Ext_bifactor3<-gam(CT_gmOccipitalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorExt*age, data=subjData_subset)
CTparietal_Ext_bifactor3<-gam(CT_gmParietalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorExt*age, data=subjData_subset)
CTtemporal_Ext_bifactor3<-gam(CT_gmTemporalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorExt*age, data=subjData_subset)

CTgm_Phb_bifactor3<-gam(CT_gmTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPhb*age, data=subjData_subset)
CTfrontal_Phb_bifactor3<-gam(CT_gmFrontalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPhb*age, data=subjData_subset)
CToccipital_Phb_bifactor3<-gam(CT_gmOccipitalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPhb*age, data=subjData_subset)
CTparietal_Phb_bifactor3<-gam(CT_gmParietalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPhb*age, data=subjData_subset)
CTtemporal_Phb_bifactor3<-gam(CT_gmTemporalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorPhb*age, data=subjData_subset)

CTgm_OverallPsy_bifactor3<-gam(CT_gmTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorOverallPsy*age, data=subjData_subset)
CTfrontal_OverallPsy_bifactor3<-gam(CT_gmFrontalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorOverallPsy*age, data=subjData_subset)
CToccipital_OverallPsy_bifactor3<-gam(CT_gmOccipitalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorOverallPsy*age, data=subjData_subset)
CTparietal_OverallPsy_bifactor3<-gam(CT_gmParietalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorOverallPsy*age, data=subjData_subset)
CTtemporal_OverallPsy_bifactor3<-gam(CT_gmTemporalTotal~s(age)+sex+s(age,by=sex)+goassessItemBifactor4FactorOverallPsy*age, data=subjData_subset)
