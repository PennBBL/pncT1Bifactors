...
CT_NoTBV_AllAnx_Stai_Gm <- lapply(CT_Gm_List, function(x) {
    gam(substitute(i ~ s(age) + sex + StaiPreStateBifactorGScore + StaiPreTraitBifactorGScore, list(i = as.name(x))), data = AllAnxSubjData)
})
...
CT_NoTBV_AllAnx_Trait_Gm <- lapply(CT_Gm_List, function(x) {
    gam(substitute(i ~ s(age) + sex + StaiPreTraitBifactorGScore, list(i = as.name(x))), data = AllAnxSubjData)
})
...
CT_NoTBV_AllAnxTd_Stai_Gm <- lapply(CT_Gm_List, function(x) {
    gam(substitute(i ~ s(age) + sex + StaiPreStateBifactorGScore + StaiPreTraitBifactorGScore, list(i = as.name(x))), data = AllAnxTdSubjData)
})
...
CT_NoTBV_AllAnxTd_Trait_Gm <- lapply(CT_Gm_List, function(x) {
    gam(substitute(i ~ s(age) + sex + StaiPreTraitBifactorGScore, list(i = as.name(x))), data = AllAnxTdSubjData)
})
...
CT_NoTBV_AllSubj_Stai_Gm <- lapply(CT_Gm_List, function(x) {
    gam(substitute(i ~ s(age) + sex + StaiPreStateBifactorGScore + StaiPreTraitBifactorGScore, list(i = as.name(x))), data = staiSubjData)
})
...
CT_NoTBV_AllSubj_Trait_Gm <- lapply(CT_Gm_List, function(x) {
    gam(substitute(i ~ s(age) + sex + StaiPreTraitBifactorGScore, list(i = as.name(x))), data = staiSubjData)
})
