...
#Create a vector p-values
Vol_TBV_GmWmCsf_CoarseAnxTd<-sapply(Vol_TBV_CoarseAnxVsTd_GmWmCsf, function(v) summary(v)$p.table[4,4])

#FDR correct p-values
Vol_TBV_GmWmCsf_CoarseAnxTd_fdr<-p.adjust(Vol_TBV_GmWmCsf_CoarseAnxTd,method="fdr")
...
#Create a vector p-values
Vol_TBV_Lobes_CoarseAnxTd<-sapply(Vol_TBV_CoarseAnxVsTd_Lobes, function(v) summary(v)$p.table[4,4])

#FDR correct p-values
Vol_TBV_Lobes_CoarseAnxTd_fdr<-p.adjust(Vol_TBV_Lobes_CoarseAnxTd,method="fdr")
...
#Create a vector p-values
Vol_TBV_ROIs_CoarseAnxTd<-sapply(Vol_TBV_CoarseAnxVsTd_ROIs, function(v) summary(v)$p.table[4,4])

#FDR correct p-values
Vol_TBV_ROIs_CoarseAnxTd_fdr<-p.adjust(Vol_TBV_ROIs_CoarseAnxTd,method="fdr")
...
Vol_TBV_AllAnxTd_Stai_GmWmCsf <- lapply(Vol_GmWmCsf_List, function(x) {
    gam(substitute(i ~ s(age) + sex + mprage_antsCT_vol_TBV + StaiPreStateBifactorGScore + StaiPreTraitBifactorGScore, list(i = as.name(x))), data = AllAnxTdSubjData)
})
...
Vol_TBV_AllSubj_Stai_GmWmCsf <- lapply(Vol_GmWmCsf_List, function(x) {
    gam(substitute(i ~ s(age) + sex + mprage_antsCT_vol_TBV + StaiPreStateBifactorGScore + StaiPreTraitBifactorGScore, list(i = as.name(x))), data = subjData)
})
