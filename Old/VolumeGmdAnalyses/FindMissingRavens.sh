...
if [ ! -d /data/joy/BBL/studies/pnc/processedData/structural/ravens/${a} ]; then
    ...
    echo $a,$b,$c >> /data/joy/BBL/projects/pncT1AcrossDisorder_Volume/subjectData/MissingDirs.csv
...
if [ ! -d /data/joy/BBL/studies/pnc/processedData/structural/ravens/${a}/*x${b} ]; then
    ...
    echo $a,$b,$c >> /data/joy/BBL/projects/pncT1AcrossDisorder_Volume/subjectData/MissingScanidDirs.csv
...
if [ ! -f /data/joy/BBL/studies/pnc/processedData/structural/ravens/${a}/*x${b}/*_150.nii.gz ]; then
    ...
    echo $a,$b,$c >> /data/joy/BBL/projects/pncT1AcrossDisorder_Volume/subjectData/Missing150.csv
...
if [ ! -f /data/joy/BBL/studies/pnc/processedData/structural/ravens/${a}/*x${b}/*_150_2mm.nii.gz ]; then
    ...
    echo $a,$b,$c >> /data/joy/BBL/projects/pncT1AcrossDisorder_Volume/subjectData/Missing2mm.csv
...
cd /data/joy/BBL/projects/pncT1AcrossDisorder_Volume/subjectData
