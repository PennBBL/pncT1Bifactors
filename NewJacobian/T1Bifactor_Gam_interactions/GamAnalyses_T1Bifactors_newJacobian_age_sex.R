...
#Make sex an ordered variable (only need ordered if doing an interaction with a spline age term- also spline interactions don't work for more than two levels)
...
x<-lm(newJacobian_Nmf18C1 ~ age + sex + age*sex + averageManualRating + mood_4factorv2 + psychosis_4factorv2 + externalizing_4factorv2 + phobias_4factorv2 + overall_psychopathology_4factorv2, data = data.JAC)

jpeg('NMF1_vol_ageSex.jpg')
visreg(x, "age*sex")
dev.off()
