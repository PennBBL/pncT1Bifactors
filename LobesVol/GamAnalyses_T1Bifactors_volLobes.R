...
lobes <- c("mprage_jlf_vol_Limbic_Lobe_WM","mprage_jlf_vol_Insular_Lobe_WM","mprage_jlf_vol_Frontal_Lobe_WM","mprage_jlf_vol_Parietal_Lobe_WM","mprage_jlf_vol_Occipital_Lobe_WM","mprage_jlf_vol_Temporal_Lobe_WM")
...
##############################################
#### PLOT OVERALL PSY BY VOL IN EACH LOBE ####
##############################################
...
### Limbic ###
##############
plotdata <- visreg(LobeModels[[1]],'overall_psychopathology_4factorv2',type = "conditional",scale = "linear", plot = FALSE)
...
Limbic<-ggplot() +
  ...
  labs(x = "Overall (z)", y = bquote(bold('Limbic Volume'~(cc^3)))) +
  theme(axis.title=element_text(size=30,face="bold"), axis.text=element_text(size=20), axis.title.x=element_text(color = "black"))

ggsave(file="/data/jux/BBL/projects/pncT1AcrossDisorder/TablesFigures/Scatterplot_volLimbic_overall.png")


###############
### Insular ###
###############
plotdata <- visreg(LobeModels[[2]],'overall_psychopathology_4factorv2',type = "conditional",scale = "linear", plot = FALSE)
smooths <- data.frame(Variable = plotdata$meta$x,
                      x=plotdata$fit[[plotdata$meta$x]],
                      smooth=plotdata$fit$visregFit,
                      lower=plotdata$fit$visregLwr,
...
Limbic<-ggplot() +
  ...
  annotate("text",x = -Inf, y = Inf, hjust = -0.1,vjust = 1,label = p_text, parse=TRUE,size = 10, colour = "black",fontface ="italic" ) +
  theme(legend.position = "none") +
  labs(x = "Overall (z)", y = bquote(bold('Insular Volume'~(cc^3)))) +
  theme(axis.title=element_text(size=30,face="bold"), axis.text=element_text(size=20), axis.title.x=element_text(color = "black"))

ggsave(file="/data/jux/BBL/projects/pncT1AcrossDisorder/TablesFigures/Scatterplot_volInsular_overall.png")

###############
### Frontal ###
###############
plotdata <- visreg(LobeModels[[3]],'overall_psychopathology_4factorv2',type = "conditional",scale = "linear", plot = FALSE)
smooths <- data.frame(Variable = plotdata$meta$x,
                      x=plotdata$fit[[plotdata$meta$x]],
                      smooth=plotdata$fit$visregFit,
                      lower=plotdata$fit$visregLwr,
...
Limbic<-ggplot() +
  ...
  annotate("text",x = -Inf, y = Inf, hjust = -0.1,vjust = 1,label = p_text, parse=TRUE,size = 10, colour = "black",fontface ="italic" ) +
  theme(legend.position = "none") +
  labs(x = "Overall (z)", y = bquote(bold('Frontal Volume'~(cc^3)))) +
...
ggsave(file="/data/jux/BBL/projects/pncT1AcrossDisorder/TablesFigures/Scatterplot_volFrontal_overall.png")

#################
### Occipital ###
#################
plotdata <- visreg(LobeModels[[5]],'overall_psychopathology_4factorv2',type = "conditional",scale = "linear", plot = FALSE)
smooths <- data.frame(Variable = plotdata$meta$x,
                      x=plotdata$fit[[plotdata$meta$x]],
                      smooth=plotdata$fit$visregFit,
                      lower=plotdata$fit$visregLwr,
...
Limbic<-ggplot() +
  ...
  annotate("text",x = -Inf, y = Inf, hjust = -0.1,vjust = 1,label = p_text, parse=TRUE,size = 10, colour = "black",fontface ="italic" ) +
  theme(legend.position = "none") +
  labs(x = "Overall (z)", y = bquote(bold('Occipital Volume'~(cc^3)))) +
...
ggsave(file="/data/jux/BBL/projects/pncT1AcrossDisorder/TablesFigures/Scatterplot_volOccipital_overall.png")

################
### Temporal ###
################
plotdata <- visreg(LobeModels[[6]],'overall_psychopathology_4factorv2',type = "conditional",scale = "linear", plot = FALSE)
smooths <- data.frame(Variable = plotdata$meta$x,
                      x=plotdata$fit[[plotdata$meta$x]],
                      smooth=plotdata$fit$visregFit,
                      lower=plotdata$fit$visregLwr,
...
Limbic<-ggplot() +
  ...
  annotate("text",x = -Inf, y = Inf, hjust = -0.1,vjust = 1,label = p_text, parse=TRUE,size = 10, colour = "black",fontface ="italic" ) +
  theme(legend.position = "none") +
  labs(x = "Overall (z)", y = bquote(bold('Temporal Volume'~(cc^3)))) +
...
ggsave(file="/data/jux/BBL/projects/pncT1AcrossDisorder/TablesFigures/Scatterplot_volTemporal_overall.png")

################
### Parietal ###
################
plotdata <- visreg(LobeModels[[4]],'overall_psychopathology_4factorv2',type = "conditional",scale = "linear", plot = FALSE)
smooths <- data.frame(Variable = plotdata$meta$x,
                      x=plotdata$fit[[plotdata$meta$x]],
                      smooth=plotdata$fit$visregFit,
                      lower=plotdata$fit$visregLwr,
...
Limbic<-ggplot() +
  ...
  annotate("text",x = -Inf, y = Inf, hjust = -0.1,vjust = 1,label = p_text, parse=TRUE,size = 10, colour = "black",fontface ="italic" ) +
  theme(legend.position = "none") +
  labs(x = "Overall (z)", y = bquote(bold('Parietal Volume'~(cc^3)))) +
...
ggsave(file="/data/jux/BBL/projects/pncT1AcrossDisorder/TablesFigures/Scatterplot_volParietal_overall.png")
...
#ggsave(file="/data/jux/BBL/projects/pncT1AcrossDisorder/TablesFigures/Figure_ct_LimbicFear.png")
