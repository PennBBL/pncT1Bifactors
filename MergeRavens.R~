...
subjData<-readRDS('/data/joy/BBL/projects/pncT1AcrossDisorder_Volume/subjectData/n1355_JLF_subjData.rds')
ravensPaths<-read.csv("/data/joy/BBL/projects/pncT1AcrossDisorder_Volume/subjectData/n1355_RavensPaths.csv", header=FALSE)
...
#Save file.
saveRDS(data.merge, "/data/joy/BBL/projects/pncT1AcrossDisorder_Volume/subjectData/n1355_JLF_subjData_Ravens.rds")
