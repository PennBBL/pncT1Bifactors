...
subjData<-readRDS("/data/joy/BBL/projects/pncT1AcrossDisorder/subjectData/n1359_JLF_volCtGmd_subjData.rds")
...
ggsave(file="/data/joy/BBL/projects/pncT1AcrossDisorder/TablesFigures/Figure2a_LobeVolByDiag_NoTBV.png", width = 15, height = 5, units = "in", dpi = 300)
...
ggsave(file="/data/joy/BBL/projects/pncT1AcrossDisorder/TablesFigures/Figure2b_LobeCTByDiag_NoTBV.png", width = 15, height = 5, units = "in", dpi = 300)
