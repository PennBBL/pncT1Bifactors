#Get the Ravens volume filenames for vol, ct, and gmd (n=1375)
...
echo $fileName >> /data/joy/BBL/projects/pncT1AcrossDisorder/subjectData/n1375_Ravens_FileNames.csv
